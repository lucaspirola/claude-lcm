"""Session-pattern helpers for session filtering.
...
(https://github.com/stephenschoettler/hermes-lcm) session_patterns.py at
v0.2.0, Copyright (c) Stephen Schoettler, MIT License.
"""
