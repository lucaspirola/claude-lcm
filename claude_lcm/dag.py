...
---
Lifted unchanged from hermes-lcm
(https://github.com/stephenschoettler/hermes-lcm) dag.py at v0.2.0,
Copyright (c) Stephen Schoettler, MIT License. In claude-lcm v1 this
table sits empty; compaction is a v2 addition that will populate it.
"""
